...
<body>
	<div align="center">
        <ul>
            <li style="background-color:#FF7F24"><a href="https://<?php echo $_SERVER['SERVER_NAME']?>/jsapi.php">JSAPI支付</a></li>
            <li style="background-color:#698B22"><a href="https://<?php echo $_SERVER['SERVER_NAME']?>/micropay.php">刷卡支付</a></li>
